const I18N_TRANSLATIONS = {
    ru: {
        ...
        btn_change_duty_room: "Сменить комнату",
        duty_list_title: "Календарь дежурств на текущий месяц",
        badge_duty_exempt: "Без дежурств",
        btn_exempt_duty: "Освободить комнату от дежурств",
        btn_include_duty: "Включить комнату в график дежурств",
        confirm_exempt_room: "Освободить комнату {room} от дежурств?",
        confirm_include_room: "Вернуть комнату {room} в график дежурств?",
        duty_primary_lead: "Ответственный:",
    ...
    en: {
        ...
        btn_change_duty_room: "Change Room",
        duty_list_title: "Monthly Duty Calendar",
        badge_duty_exempt: "Duty Exempt",
        btn_exempt_duty: "Exempt room from duty",
        btn_include_duty: "Include room in duty",
        confirm_exempt_room: "Exempt room {room} from duty roster?",
        confirm_include_room: "Include room {room} back into duty roster?",
        duty_primary_lead: "Lead:",
    ...
    uz: {
        ...
        btn_change_duty_room: "Xonani almashtirish",
        duty_list_title: "Joriy oy uchun navbatchilik kalendari",
        badge_duty_exempt: "Navbatchiliksiz",
        btn_exempt_duty: "Xonani navbatchilikdan ozod qilish",
        btn_include_duty: "Xonani navbatchilikka qo'shish",
        confirm_exempt_room: "{room}-xonani navbatchilikdan ozod qilasizmi?",
        confirm_include_room: "{room}-xonani navbatchilikka qaytarasizmi?",
        duty_primary_lead: "Mas'ul:",
